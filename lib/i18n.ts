...
const KO: Msg = {
  ...
  "timeline.editWorkout": "운동 수정",
  "timeline.markDone": "완료 표시 (클릭)",
  "timeline.markUndone": "완료 해제 (클릭)",
  "timeline.dayProgress": "오늘 진척",
  "timeline.percentDone": "{n}% 완료",
  "timeline.workoutLabel": "운동 내용",
  "timeline.workoutPh": "예: 요가 60분 · 자전거 30분 · 필라테스",
...
const EN: Msg = {
  ...
  "timeline.editWorkout": "Edit workout",
  "timeline.markDone": "Mark done (click)",
  "timeline.markUndone": "Mark undone (click)",
  "timeline.dayProgress": "Today's progress",
  "timeline.percentDone": "{n}% done",
  "timeline.workoutLabel": "What workout?",
  "timeline.workoutPh": "e.g., Yoga 60min · Cycling · Pilates",
